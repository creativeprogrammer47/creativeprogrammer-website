...
function Links() {
  return (
    <div className="links__main">
      ...
      <div className="icons">
        <Link
          to={{ pathname: "https://www.instagram.com/creative__programmer" }}
          target="_blank"
        >
          <Button>
        ...
        <Link
          to={{ pathname: "https://github.com/creativeprogrammer47" }}
          target="_blank"
        >
        ...
        <Link
          to={{ pathname: "mailto: creativeprogrammer47@gmail.com?" }}
          target="_blanck"
        >
          <Button>
        ...
        <Link
          to={{ pathname: "https://znap.link/creative-programmer" }}
          target="_blanck"
        >
          <Button>
            More links
